...
### 参考资料：尚硅谷课程大纲、尚硅谷课程课件、《Java核心技术》、cyc2018
...
![image-20210224141316565](D:\坚果云\我的坚果云\LA学习\LearningRecord\多线程.assets\image-20210224141316565.png)
...
 好处：  提高响应速度（减少了创建新线程的时间）  降低资源消耗（重复利用线程池中线程，不需要每次都创建）  便于线程管理  corePoolSize：核心池的大小  maximumPoolSize：最大线程数  keepAliveTime：线程没有任务时最多保持多长时间后会终止

![image-20210224223741583](D:\坚果云\我的坚果云\LA学习\LearningRecord\多线程.assets\image-20210224223741583.png)
...
![image-20210224195820598](D:\坚果云\我的坚果云\LA学习\LearningRecord\多线程.assets\image-20210224195820598.png)

![image-20210224200136769](D:\坚果云\我的坚果云\LA学习\LearningRecord\多线程.assets\image-20210224200136769.png)

![image-20210224200545058](D:\坚果云\我的坚果云\LA学习\LearningRecord\多线程.assets\image-20210224200545058.png)
...
1. synchronized放循环while里面会出现死锁问题？
2. 怎么解决死锁问题？
3. CAS的作用？
4. 如何创建线程安全的变量？
